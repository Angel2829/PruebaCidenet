...
void actualizar(){
        if (Cod1.getText().isEmpty()||nombre1.getText().isEmpty()||Descripcion1.getText().isEmpty()||Stock1.getText().isEmpty()){
            ...
            JOptionPane.showMessageDialog(null, "La cantidad a Agregar debe ser mayor a (0) ","Alerta",JOptionPane.WARNING_MESSAGE);
               ...
               int Agg=Integer.parseInt(Cantidad.getText());
               int AgregarST=canti+Agg;
               cone2=conex.CargarBD();     
               try {
                                           Statement orden1 =cone2.createStatement();
                                           String crear = "Update  Productos  set STOCK="+AgregarST+"where PRODUCTOID="+Cod1.getText();
                                           orden1.executeUpdate(crear);
                                           JOptionPane.showMessageDialog(null, "Se ha Cargado al Stock de "+nombre1.getText()+" "+Agg+" Unidades \n La cantidad actual es de "+AgregarST+" Unidades");
                                           Tabla();
                                           limpiar();
                                           } 
                                            catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        Descripcion.setText("Digite la Cantidad a agregar");
        ...
        Agregar.setText("Agregar Cantidad");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CargarStock().setVisible(true);
            }
        });
    }
